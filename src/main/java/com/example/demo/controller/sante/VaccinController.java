...
public class VaccinController {
        ...
        public String index(Model model) {
                ...
                model.addAttribute("rappelsCount",
                                vaccinService.getVaccinsPrioritaires().stream()
                                                .filter(h -> h.getAlerteId() != null && !h.getAlerteAcquittee())
                                                .count());
        ...
        public String importHistorique(@RequestParam("file") MultipartFile file,
                ...
                try {
                        ...
                        redirectAttributes.addFlashAttribute("success",
                                        "L'importation de l'historique a été effectuée avec succès !");
                } catch (Exception e) {
